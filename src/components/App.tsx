        ...
        <>
            <div className={`relative ${loading ? '' : isCartVisiblePath ? 'lg:mx-0' : ''}`}>
                ...
                <div className="relative w-full mt-20 h-screen overflow-hidden">
                    <video src='https://photos.app.goo.gl/BX1xo5K65vZqwLPL6' autoPlay loop muted className="absolute inset-0 w-full h-full object-cover" style={{ maskImage: "linear-gradient(to bottom, #d6c2c2 80%, transparent 100%)"}} />
